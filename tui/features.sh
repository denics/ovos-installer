...
features=("ocp" "$OCP_DESCRIPTION" OFF)
features+=("tts" "$TTS_DESCRIPTION" OFF)
features+=("stt" "$STT_DESCRIPTION" OFF)
features+=("ww" "$WW_DESCRIPTION" OFF)
features+=("phal" "$PHAL_DESCRIPTION" OFF)
